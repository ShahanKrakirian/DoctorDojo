	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-10">
				<h5 class="text-center">Visits</h5>
				<div class="table-responsive">
					<table class="table table-sm table-hover no-gutters">
						<thead>
							<tr>
								<th>Case Number</th>
								<th>Visit Date</th>
								...
								<tr>
									...
									<td>
										...
										<c:if test = "${pv.visitStatus.equals('Complete')}">
											Visit Closed
											<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Historical View</button>
										</c:if>
									</td>
								</tr>
